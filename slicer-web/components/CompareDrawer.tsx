        ...
        >
          <div>
            ...
            <p style={{ margin: 0, color: '#94a3b8' }}>
              Selecione pelo menos duas estimativas para visualizar diferenças de custo, tempo e material.
            </p>
          </div>
                ...
                {selectedEstimates.map((estimate, index) => (
                  ...
                  >
                    <div>
                      ...
                      {index === 0 ? (
                        <span style={{ color: '#38bdf8', fontSize: '0.75rem', fontWeight: 600 }}>Referência</span>
                      ) : null}
                    </div>
                    <dl style={{ display: 'grid', gap: '0.75rem', margin: 0 }}>
                      {METRICS.map((metric) => {
                        ...
                        return (
                          ...
                          >
                            <dt style={{ fontSize: '0.75rem', color: '#94a3b8', textTransform: 'uppercase' }}>
                              {metric.label}
                            </dt>
                            <dd style={{ margin: 0, fontSize: '1.25rem', fontWeight: 600 }}>
                              {formatValue(value, metric.precision ?? 2)}
                            </dd>
                            <span style={{ fontSize: '0.75rem', color: delta.color }}>{delta.text}</span>
                          </div>
                        );
                      })}
                    </dl>
